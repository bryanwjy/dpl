...
#include "dpl/configuration/declspec.h"
#include "dpl/preprocessor/apply_macro.h"
...
#define __DPL_CPP_ATTRIBUTE_SCOPE(...)                                      \
    DPL_PASTE(DPL_APPEND_IS_EMPTY(__DPL_CPP_ATTRIBUTE_SCOPE_, __VA_ARGS__)( \
        __VA_ARGS__))
...
#define __DPL_GNU_ATTRIBUTE_SCOPE(...)                                      \
    DPL_PASTE(DPL_APPEND_IS_EMPTY(__DPL_GNU_ATTRIBUTE_SCOPE_, __VA_ARGS__)( \
        __VA_ARGS__))
...
#define __DPL_DECLSPEC_SCOPE(...) \
    DPL_PASTE(                    \
        DPL_APPEND_IS_EMPTY(__DPL_DECLSPEC_SCOPE_, __VA_ARGS__)(__VA_ARGS__))

#define __DPL_TRANSLATE_ATTRIBUTE(ARGS) \
    DPL_SWAP_CONCAT(_END, __DPL_TRANSLATE_ATTRIBUTE_1 ARGS)
...
#define __DPL_BUILD_ATTRIBUTE_LIST(ARGS) \
    DPL_SWAP_CONCAT(_END, __DPL_BUILD_ATTRIBUTE_LIST_1 ARGS)
...
#define __DPL_FILTER_CPP_ATTRIBUTES(ARGS) \
    DPL_SWAP_CONCAT(_END, __DPL_FILTER_CPP_ATTRIBUTES_1 ARGS)
...
#define __DPL_CPP_ATTRIBUTES(LIST)                        \
    __DPL_CPP_ATTRIBUTE_SCOPE(__DPL_BUILD_ATTRIBUTE_LIST( \
        __DPL_TRANSLATE_ATTRIBUTE(__DPL_FILTER_CPP_ATTRIBUTES(LIST))))

#define __DPL_FILTER_GNU_ATTRIBUTES(ARGS) \
    DPL_SWAP_CONCAT(_END, __DPL_FILTER_GNU_ATTRIBUTES_1 ARGS)
...
#define __DPL_GNU_ATTRIBUTES(LIST)                        \
    __DPL_GNU_ATTRIBUTE_SCOPE(__DPL_BUILD_ATTRIBUTE_LIST( \
        __DPL_TRANSLATE_ATTRIBUTE(__DPL_FILTER_GNU_ATTRIBUTES(LIST))))
...
#  define __DPL_FILTER_DECLSPEC_ATTRIBUTES_1(NAME)                \
      __DPL_ATTRIBUTE_FILTER(                                     \
          NAME, DPL_CONCAT(__DPL_ATTRIBUTE_TYPE_DECLSPEC_, NAME)) \
...
#define __DPL_ATOMIZE_ATTRIBUTE(NAME)                       \
    DPL_PASTE(DPL_APPEND_IS_EMPTY(__DPL_ATOMIZE_ATTRIBUTE_, \
        DPL_CONCAT(__DPL_ATTRIBUTE_TYPE_AGGREGATE_, NAME))(NAME))

#define __DPL_ATTRIBUTE_ATOMIZATION(ARGS) \
    DPL_SWAP_CONCAT(_END, __DPL_ATTRIBUTE_ATOMIZATION_1 ARGS)
#if DPL_MSVC_PREPROCESSOR
...
#define __DPL_EXPAND_ATOMIC_ATTRIBUTES(LIST) \
    ...
    __DPL_GNU_ATTRIBUTES(LIST)               \
    __DPL_DECLSPEC(LIST)

#define __DPL_ATTRIBUTES(LIST) \
    __DPL_EXPAND_ATOMIC_ATTRIBUTES(__DPL_ATTRIBUTE_ATOMIZATION(LIST))
...
#define DPL_CPP_ATTRIBUTES(...) \
    __DPL_CPP_ATTRIBUTES(__DPL_TO_ITERABLE(__VA_ARGS__))
#define DPL_CPP_ATTRIBUTE(ATTR) __DPL_CPP_ATTRIBUTES((ATTR))

#define DPL_GNU_ATTRIBUTES(...) \
    __DPL_GNU_ATTRIBUTES(__DPL_TO_ITERABLE(__VA_ARGS__))
#define DPL_GNU_ATTRIBUTE(ATTR) __DPL_GNU_ATTRIBUTES((ATTR))

#define DPL_DECLSPEC_ATTRIBUTES(...) \
    __DPL_DECLSPEC(__DPL_TO_ITERABLE(__VA_ARGS__))
...
#define DPL_HAS_ATTRIBUTE(NAME) \
    __DPL_HAS_ATTRIBUTE(__DPL_ATTRIBUTE_ATOMIZATION((NAME)))
