...
#  define DPL_APPLY_MACRO_IMPL(F, _0, ...)                                   \
      F(_0)                                                                  \
      __VA_OPT__(DPL_APPLY_MACRO_LOOP DPL_APPLY_MACRO_PARENTHESIS DPL_PASTE( \
          (F, __VA_ARGS__)))
#  define DPL_APPLY_MACRO_LOOP() DPL_APPLY_MACRO_IMPL

#  define DPL_APPLY_MACRO(F, ...) \
      __VA_OPT__(DPL_EVAL(DPL_APPLY_MACRO_IMPL(F, __VA_ARGS__)))
...
#    define DPL_APPLY_MACRO_NEXT1(test, next) \
        DPL_APPLY_MACRO_NEXT0(test, next, 0)
...
#    define DPL_APPLY_MACRO_NEXT1(test, next) \
        DPL_PASTE(DPL_APPLY_MACRO_NEXT0(test, next, 0))
#    define DPL_APPLY_MACRO_NEXT(test, next) \
        DPL_PASTE(DPL_APPLY_MACRO_NEXT1(DPL_APPLY_MACRO_GET_END test, next))
#    define DPL_APPLY_MACRO0(f, x, peek, ...)                        \
        f(x) DPL_PASTE(DPL_APPLY_MACRO_NEXT(peek, DPL_APPLY_MACRO1)( \
            f, peek, __VA_ARGS__))
#    define DPL_APPLY_MACRO1(f, x, peek, ...)                        \
        f(x) DPL_PASTE(DPL_APPLY_MACRO_NEXT(peek, DPL_APPLY_MACRO0)( \
            f, peek, __VA_ARGS__))
...
#  define DPL_APPLY_MACRO_LIST0(f, x, peek, ...)                             \
      f(x) DPL_PASTE(DPL_APPLY_MACRO_LIST_NEXT(peek, DPL_APPLY_MACRO_LIST1)( \
          f, peek, __VA_ARGS__))
#  define DPL_APPLY_MACRO_LIST1(f, x, peek, ...)                             \
      f(x) DPL_PASTE(DPL_APPLY_MACRO_LIST_NEXT(peek, DPL_APPLY_MACRO_LIST0)( \
          f, peek, __VA_ARGS__))
