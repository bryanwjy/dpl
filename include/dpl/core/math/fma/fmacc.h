...
template <>
struct fallback_impl<fmacc_t> : fm_canonical_broadcaster<fmacc_t> {
    ...
    static consteval T operator()(T lhs, T mid, T rhs) noexcept {
    ...
    using fm_canonical_broadcaster<fmacc_t>::operator();
};

template <typename AT, typename BT, typename CT, typename T>
concept unqualified_canonical_fmacc =
    unqualified_canonical_fmadd<BT, CT, AT, T>;

template <typename AT, typename M, typename BT, typename CT>
concept unqualified_canonical_mfmacc =
    cpo_invocable<fmacc_t, AT, BT, CT> && requires {
        {
            fmadd(internal::abi<cpo_result_t<fmacc_t, AT, BT, CT>>,
                internal::declarg<BT>(), internal::declarg<CT>(),
                internal::declarg<AT>(), internal::declarg<M>())
        } -> same_as<cpo_result_t<fmacc_t, AT, BT, CT>>;
    };
...
concept unqualified_canonical_zmfmacc =
    cpo_invocable<fmacc_t, AT, BT, CT> && requires {
        {
            fmadd(internal::abi<cpo_result_t<fmacc_t, AT, BT, CT>>, dx::zero,
...
private:
    template <typename AT, typename BT, typename CT>
    using result_t DPL_NODEBUG = cpo_result_t<fmacc_t, AT, BT, CT>;
...
public:
    ...
    requires canonical_vector<BT> && canonical_vector<CT> &&
        unqualified_canonical_fmacc<AT, BT, CT, AT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr AT operator()(AT aval, BT bval, CT cval) noexcept {
        return fmadd(internal::abi<AT>, bval, cval, aval);
    }

    template <canonical_vector AT, vector_subsumed_by<AT> BT,
        broadcastable_to<AT> CT>
    requires canonical_vector<BT> && unqualified_canonical_fmacc<AT, BT, CT, AT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr AT operator()(AT aval, BT bval, CT&& cval) noexcept {
        return fmadd(internal::abi<AT>, bval, __DPL forward<CT>(cval), aval);
    }

    template <canonical_vector AT, vector_subsumed_by<AT> CT,
        broadcastable_to<AT> BT>
    requires canonical_vector<CT> && unqualified_canonical_fmacc<AT, BT, CT, AT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr AT operator()(AT aval, BT&& bval, CT cval) noexcept {
        return fmadd(internal::abi<AT>, __DPL forward<BT>(bval), cval, aval);
    }

    template <canonical_vector BT, common_vector_with<BT> CT,
        broadcastable_to<vector_t<BT, CT>> AT>
    requires canonical_vector<CT> &&
        unqualified_canonical_fmacc<AT, BT, CT, common_canonical_simd_t<BT, CT>>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr vector_t<BT, CT> operator()(
        AT&& aval, BT bval, CT cval) noexcept {
        return fmadd(internal::abi<common_abi_t<BT, CT>>, bval, cval,
            __DPL forward<AT>(aval));
    }

    template <canonical_vector AT, broadcastable_to<AT> BT,
        broadcastable_to<AT> CT>
    requires unqualified_canonical_fmacc<AT, BT, CT, AT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr AT operator()(AT aval, BT&& bval, CT&& cval) noexcept {
        return fmadd(internal::abi<AT>, __DPL forward<BT>(bval),
            __DPL forward<CT>(cval), aval);
    }

    template <canonical_vector BT, broadcastable_to<BT> AT,
        broadcastable_to<BT> CT>
    requires unqualified_canonical_fmacc<AT, BT, CT, BT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr BT operator()(AT&& aval, BT bval, CT&& cval) noexcept {
        return fmadd(internal::abi<BT>, bval, __DPL forward<CT>(cval),
            __DPL forward<AT>(aval));
    }

    template <canonical_vector CT, broadcastable_to<CT> AT,
        broadcastable_to<CT> BT>
    requires unqualified_canonical_fmacc<AT, BT, CT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr CT operator()(AT&& aval, BT&& bval, CT cval) noexcept {
        return fmadd(internal::abi<CT>, __DPL forward<BT>(bval), cval,
            __DPL forward<AT>(aval));
    }

    template <unextended_type AT, unextended_type BT, unextended_type CT>
    requires unqualified_canonical_mfmacc<AT, mask_t<AT, BT, CT>, BT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    ...
    template <unextended_type AT, unextended_type BT, unextended_type CT,
        result_cmask_for<fmacc_t, AT, BT, CT> M>
    requires unqualified_canonical_mfmacc<AT,
        launder_cmask_t<result_t<AT, BT, CT>, M>, BT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr result_t<AT, BT, CT> operator()(
        AT aval, M mask, BT bval, CT cval) noexcept {
        return fmadd(internal::abi<result_t<AT, BT, CT>>, bval, cval, aval,
            dx::to_const_mask<result_t<AT, BT, CT>>(mask));
    }

    template <unextended_type AT, unextended_type BT, unextended_type CT>
    requires unqualified_canonical_zmfmacc<mask_t<AT, BT, CT>, AT, BT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    ...
    template <unextended_type AT, unextended_type BT, unextended_type CT,
        result_cmask_for<fmacc_t, AT, BT, CT> M>
    requires unqualified_canonical_zmfmacc<
...
template <typename AT, typename BT, typename CT, typename T>
concept unqualified_extended_fmacc = unqualified_extended_fmadd<BT, CT, AT, T>;

template <typename AT, typename M, typename BT, typename CT>
concept unqualified_extended_mfmacc =
    cpo_invocable<fmacc_t, AT, BT, CT> && requires {
        {
...
concept unqualified_extended_zmfmacc =
    cpo_invocable<fmacc_t, AT, BT, CT> && requires {
        {
            fmadd(dx::zero, internal::declarg<M>(), internal::declarg<BT>(),
                internal::declarg<CT>(), internal::declarg<AT>())
        } -> equivalent_vector_with<cpo_result_t<fmacc_t, AT, BT, CT>>;
    };
...
public:
    ...
    requires (extended_vector<AT> || extended_vector<BT> ||
                 extended_vector<CT>) &&
        unqualified_extended_fmacc<AT, BT, CT, AT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    ...
    requires (extended_vector<BT> || extended_vector<CT>) &&
        unqualified_extended_fmacc<AT, BT, CT, vector_t<BT, CT>>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(AT&& aval, BT&& bval, CT&& cval) {
        return fmadd(__DPL forward<BT>(bval), __DPL forward<CT>(cval),
            __DPL forward<AT>(aval));
    ...
    template <extended_vector AT, broadcastable_to<AT> BT,
        broadcastable_to<AT> CT>
    requires unqualified_extended_fmacc<AT, BT, CT, AT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(AT&& aval, BT&& bval, CT&& cval) {
        return fmadd(__DPL forward<BT>(bval), __DPL forward<CT>(cval),
            __DPL forward<AT>(aval));
    ...
    template <extended_vector BT, broadcastable_to<BT> AT,
        broadcastable_to<BT> CT>
    requires unqualified_extended_fmacc<AT, BT, CT, BT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(AT&& aval, BT&& bval, CT&& cval) {
        return fmadd(__DPL forward<BT>(bval), __DPL forward<CT>(cval),
            __DPL forward<AT>(aval));
    ...
    template <extended_vector CT, broadcastable_to<CT> AT,
        broadcastable_to<CT> BT>
    requires unqualified_extended_fmacc<AT, BT, CT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(AT&& aval, BT&& bval, CT&& cval) {
        return fmadd(__DPL forward<BT>(bval), __DPL forward<CT>(cval),
            __DPL forward<AT>(aval));
    ...
    template <typename AT, typename BT, typename CT,
        result_mask_for<fmacc_t, AT, BT, CT> M>
    ...
    requires (extended_vector<AT> || extended_vector<BT> ||
                 extended_vector<CT>) &&
        unqualified_extended_mfmacc<AT,
            launder_cmask_t<cpo_result_t<fmacc_t, AT, BT, CT>, M>, BT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(AT&& aval, M mask, BT&& bval, CT&& cval) {
        return fmadd( __DPL forward<BT>(bval), __DPL forward<CT>(cval),
            __DPL forward<AT>(aval),
            dx::to_const_mask<cpo_result_t<fmacc_t, AT, BT, CT>>(mask));
    }
    ...
    requires (extended_vector<AT> || extended_vector<BT> ||
                 extended_vector<CT>) &&
        unqualified_extended_zmfmacc<
            launder_cmask_t<cpo_result_t<fmacc_t, AT, BT, CT>, M>, AT, BT, CT>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(
        dx::zero_t zero, M mask, AT&& aval, BT&& bval, CT&& cval) {
        return fmadd(zero,
