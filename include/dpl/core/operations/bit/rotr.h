...
private:
    ...
    template <typename L, typename R>
    using vimask_t DPL_NODEBUG = imask_t<cpo_result_t<rotr_t, L, R>>;

    template <typename L, typename R, vimask_t<L, R> M>
    using vcmask_t DPL_NODEBUG = cmask_t<cpo_result_t<rotr_t, L, R>, M>;
...
public:
    ...
    requires unqualified_canonical_mrotr<type_identity_t<T>, cmask_t<T, M>, T>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr T operator()(type_identity_t<T> src, cmask_t<T, M> cmask,
        T val, size_t count) noexcept {
        return rotr(internal::abi<T>, src, cmask, val, count);
    }
    ...
    template <fixed_width_vector T, imask_t<T> M>
    requires unqualified_canonical_mrotr<dx::zero_t, cmask_t<T, M>, T>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr T operator()(
        dx::zero_t zero, cmask_t<T, M> cmask, T val, size_t count) noexcept {
        return rotr(internal::abi<T>, zero, cmask, val, count);
    }
    ...
    requires canonical_vector<T> &&
        unqualified_canonical_mrotr<dx::zero_t, cmask_t<T, M>, T, N>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr T operator()(
    ...
    template <canonical_vector L, canonical_vrot_vector_for<L> R,
        vimask_t<L, R> M>
    requires unqualified_canonical_mrotr<vresult_t<L, R>, vcmask_t<L, R, M>, L,
        R>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr vresult_t<L, R> operator()(
        vresult_t<L, R> src, vcmask_t<L, R, M> cmask, L lhs, R rhs) noexcept {
        return rotr(internal::abi<common_abi_t<L, R>>, src, cmask, lhs, rhs);
    }
    ...
    template <canonical_vector L, canonical_vrot_vector_for<L> R,
        vimask_t<L, R> M>
    requires unqualified_canonical_mrotr<dx::zero_t, vcmask_t<L, R, M>, L, R>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr vresult_t<L, R> operator()(
        dx::zero_t zero, vcmask_t<L, R, M> cmask, L lhs, R rhs) noexcept {
        return rotr(internal::abi<common_abi_t<L, R>>, zero, cmask, lhs, rhs);
    }
};
...
public:
    ...
    requires unqualified_extended_mask_rotr<T>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(T&& val, size_t count) {
        return rotr(__DPL forward<T>(val), count);
    }
    ...
    requires (extended_vector<S> || extended_vector<T>) &&
        unqualified_extended_mrotr<S, cmask_t<S, M>, T>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    ...
    requires extended_vector<T> &&
        unqualified_extended_mrotr<dx::zero_t, cmask_t<T, M>, T>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(
        dx::zero_t zero, cmask_t<T, M> cmask, T&& val, size_t count) {
        return rotr(zero, cmask, __DPL forward<T>(val), count);
    }
    ...
    template <fixed_width_vector S, imask_t<S> M, common_vector_with<S> T,
        integral_constant_like N>
    requires (extended_vector<S> || extended_vector<T>) &&
        unqualified_extended_mrotr<S, cmask_t<S, M>, T, N>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(
    ...
    requires unqualified_extended_mrotr<dx::zero_t, cmask_t<T, M>, T, N>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(
    ...
    requires (extended_vector<S> || extended_vector<L> || extended_vector<R>) &&
        unqualified_extended_mrotr<S, cmask_t<S, M>, L, R>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(
        S&& src, cmask_t<S, M> cmask, L&& lhs, R&& rhs) {
        return rotr(src, cmask, __DPL forward<L>(lhs), __DPL forward<R>(rhs));
    }
    ...
    requires (extended_vector<L> || extended_vector<R>) &&
        unqualified_extended_mrotr<dx::zero_t, vcmask_t<L, R, M>, L, R>
    DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
    static constexpr auto operator()(
