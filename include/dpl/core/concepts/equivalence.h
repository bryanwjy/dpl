...
concept equivalent_simd_type_with = common_simd_type_with<T, U> &&
...
concept equivalent_vector_with =
    equivalent_simd_type_with<T, U> && simd_vector<T> && simd_vector<U>;
template <typename T, typename U>
concept equivalent_mask_with =
    equivalent_simd_type_with<T, U> && simd_mask<T> && simd_mask<U>;
