...
inline mask<E>
    DPL_VECTORCALL cmple(vector<E> lhs, vector<E> rhs) noexcept {
    return _mm_or_si128(+xmm::cmplt(lhs, rhs), +xmm::cmpeq(lhs, rhs));
}

inline mask<float> DPL_VECTORCALL cmple(
    vector<float> lhs, vector<float> rhs) noexcept {
    return _mm_cmple_ps(+lhs, +rhs);
}

inline mask<double> DPL_VECTORCALL cmple(
...
inline mask<ext::float16> DPL_VECTORCALL cmple(
    vector<ext::float16> lhs, vector<ext::float16> rhs) noexcept {
    return _mm_movm_epi16(_mm_cmp_ph_mask(+lhs, +rhs, _CMP_LE_OQ));
}

template <imask_t<ext::float16> M>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<ext::float16>
    DPL_VECTORCALL cmple(cmask_t<ext::float16, M>, vector<ext::float16> lhs,
        vector<ext::float16> rhs) noexcept {
    return _mm_movm_epi16(_mm_mask_cmp_ph_mask(M, +lhs, +rhs, _CMP_LE_OQ));
}

#  endif

DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<ext::bfloat16> DPL_VECTORCALL cmple(
    ...
    auto const lo = _mm_castps_si128(_mm_cmple_ps(llhs, lrhs));
    auto const hi = _mm_castps_si128(_mm_cmple_ps(hlhs, hrhs));
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<int64> DPL_VECTORCALL cmple(
    vector<int64> lhs, vector<int64> rhs) noexcept {
    return _mm_movm_epi64(_mm_cmp_epi64_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<int32> DPL_VECTORCALL cmple(
    vector<int32> lhs, vector<int32> rhs) noexcept {
    return _mm_movm_epi32(_mm_cmp_epi32_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

inline mask<uint64> DPL_VECTORCALL cmple(
    vector<uint64> lhs, vector<uint64> rhs) noexcept {
    return _mm_movm_epi64(_mm_cmp_epu64_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<uint32> DPL_VECTORCALL cmple(
    vector<uint32> lhs, vector<uint32> rhs) noexcept {
    return _mm_movm_epi32(_mm_cmp_epu32_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

template <imask_t<int64> M>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<int64>
    DPL_VECTORCALL cmple(
        cmask_t<int64, M>, vector<int64> lhs, vector<int64> rhs) noexcept {
    return _mm_movm_epi64(
        _mm_mask_cmp_epi64_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<int32>
    ...
    return _mm_movm_epi32(
        _mm_mask_cmp_epi32_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<uint64>
    ...
    return _mm_movm_epi64(
        _mm_mask_cmp_epu64_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<uint32>
    ...
    return _mm_movm_epi32(
        _mm_mask_cmp_epu32_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
#    endif // if DPL_SIMD_X86_AVX512F

#    if DPL_SIMD_X86_AVX512BW
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<int16> DPL_VECTORCALL cmple(
    vector<int16> lhs, vector<int16> rhs) noexcept {
    return _mm_movm_epi16(_mm_cmp_epi16_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<int8> DPL_VECTORCALL cmple(
    vector<int8> lhs, vector<int8> rhs) noexcept {
    return _mm_movm_epi8(_mm_cmp_epi8_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

inline mask<uint16> DPL_VECTORCALL cmple(
    vector<uint16> lhs, vector<uint16> rhs) noexcept {
    return _mm_movm_epi16(_mm_cmp_epu16_mask(+lhs, +rhs, _MM_CMPINT_LE));
}

DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<uint8> DPL_VECTORCALL cmple(
    vector<uint8> lhs, vector<uint8> rhs) noexcept {
    return _mm_movm_epi8(_mm_cmp_epu8_mask(+lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<int16>
    ...
    return _mm_movm_epi16(
        _mm_mask_cmp_epi16_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<int8>
    ...
    return _mm_movm_epi8(_mm_mask_cmp_epi8_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<uint16>
    ...
    return _mm_movm_epi16(
        _mm_mask_cmp_epu16_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<uint8>
    ...
    return _mm_movm_epi8(_mm_mask_cmp_epu8_mask(M, +lhs, +rhs, _MM_CMPINT_LE));
}
...
inline mask<E> cmple(abi_tag, vector<E> lhs, vector<E> rhs) noexcept
requires requires { xmm::cmple(lhs, rhs); }
{
    return xmm::cmple(lhs, rhs);
}
...
requires requires { xmm::cmple(mask, lhs, rhs); }
{
    return xmm::cmple(mask, lhs, rhs);
}
