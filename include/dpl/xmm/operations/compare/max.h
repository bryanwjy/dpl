...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int32>
    DPL_VECTORCALL max(vector<int32> src, cmask_t<int32, M>, vector<int32> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int32>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<int32, M>, vector<int32> lhs,
        vector<int32> rhs) noexcept {
...
inline vector<uint32>
    DPL_VECTORCALL max(vector<uint32> src, cmask_t<uint32, M>,
        vector<uint32> lhs, vector<uint32> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<uint32>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<uint32, M>, vector<uint32> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int64>
    DPL_VECTORCALL max(vector<int64> src, cmask_t<int64, M>, vector<int64> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int64>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<int64, M>, vector<int64> lhs,
        vector<int64> rhs) noexcept {
...
inline vector<uint64>
    DPL_VECTORCALL max(vector<uint64> src, cmask_t<uint64, M>,
        vector<uint64> lhs, vector<uint64> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<uint64>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<uint64, M>, vector<uint64> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<float>
    DPL_VECTORCALL max(vector<float> src, cmask_t<float, M>, vector<float> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<float>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<float, M>, vector<float> lhs,
        vector<float> rhs) noexcept {
...
inline vector<double>
    DPL_VECTORCALL max(vector<double> src, cmask_t<double, M>,
        vector<double> lhs, vector<double> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<double>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<double, M>, vector<double> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int8>
    DPL_VECTORCALL max(vector<int8> src, cmask_t<int8, M>, vector<int8> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int8>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<int8, M>, vector<int8> lhs,
        vector<int8> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<uint8>
    DPL_VECTORCALL max(vector<uint8> src, cmask_t<uint8, M>, vector<uint8> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<uint8>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<uint8, M>, vector<uint8> lhs,
        vector<uint8> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int16>
    DPL_VECTORCALL max(vector<int16> src, cmask_t<int16, M>, vector<int16> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<int16>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<int16, M>, vector<int16> lhs,
        vector<int16> rhs) noexcept {
...
inline vector<uint16>
    DPL_VECTORCALL max(vector<uint16> src, cmask_t<uint16, M>,
        vector<uint16> lhs, vector<uint16> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<uint16>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<uint16, M>, vector<uint16> lhs,
...
inline vector<ext::float16>
    DPL_VECTORCALL max(vector<ext::float16> src, cmask_t<ext::float16, M>,
        vector<ext::float16> lhs, vector<ext::float16> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::float16>
    DPL_VECTORCALL max(dx::zero_t, cmask_t<ext::float16, M>,
        vector<ext::float16> lhs, vector<ext::float16> rhs) noexcept {
