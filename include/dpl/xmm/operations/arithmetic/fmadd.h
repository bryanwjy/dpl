...
inline vector<ext::bfloat16> DPL_VECTORCALL fmadd(vector<ext::bfloat16> lhs,
    ...
    auto const lo =
        xmm::fmadd(xmm::to_float(lhs), xmm::to_float(mid), xmm::to_float(rhs));
    auto const hi = xmm::fmadd(
        xmm::to_float(hlhs), xmm::to_float(hmid), xmm::to_float(hrhs));
...
inline vector<ext::bfloat16>
    ...
    auto const lo = xmm::fmadd(
        xmm::to_float(lhs), lmask, xmm::to_float(mid), xmm::to_float(rhs));
    auto const hi = xmm::fmadd(
        xmm::to_float(hlhs), hmask, xmm::to_float(hmid), xmm::to_float(hrhs));
...
inline vector<ext::bfloat16>
    ...
    constexpr cmask_t<float, (M & 0xf)> lmask;
    constexpr cmask_t<float, (M >> 4)> hmask;
    auto const lo = xmm::fmadd(zero, lmask, xmm::to_float(lhs),
        xmm::to_float(mid), xmm::to_float(rhs));
    auto const hi = xmm::fmadd(zero, hmask, xmm::to_float(hlhs),
        xmm::to_float(hmid), xmm::to_float(hrhs));
...
inline vector<ext::bfloat16>
    ...
    constexpr cmask_t<float, (M >> 4)> hmask;
    auto const lo = xmm::fmadd(
        xmm::to_float(lhs), xmm::to_float(mid), xmm::to_float(rhs), lmask);
    auto const hi = xmm::fmadd(
        xmm::to_float(hlhs), xmm::to_float(hmid), xmm::to_float(hrhs), hmask);
