...
inline simd<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwor(simd<L> lhs, simd<R> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwand(simd<L> lhs, simd<R> rhs) noexcept {
    using bits = common_bits_type_t<L, R>;
    if constexpr (same_as<__m128i, native_vector_t<bits>>) {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwxor(simd<L> lhs, simd<R> rhs) noexcept {
    using bits = common_bits_type_t<L, R>;
    if constexpr (same_as<__m128i, native_vector_t<bits>>) {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwandnot(simd<L> lhs, simd<R> rhs) noexcept {
    using bits = common_bits_type_t<L, R>;
    if constexpr (same_as<__m128i, native_vector_t<bits>>) {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<E> DPL_VECTORCALL bwnot(simd<E> val) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwornot(simd<L> lhs, simd<R> rhs) noexcept {
    return xmm::bwnot(xmm::bwandnot(rhs, lhs));
}

template <simd_element L, simd_element R>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline auto bwor(abi_tag, simd<L> lhs, simd<R> rhs) noexcept
...
template <simd_element L, simd_element R>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline auto bwand(abi_tag, simd<L> lhs, simd<R> rhs) noexcept
...
template <simd_element L, simd_element R>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline auto bwxor(abi_tag, simd<L> lhs, simd<R> rhs) noexcept
...
template <simd_element L, simd_element R>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline auto bwandnot(abi_tag, simd<L> lhs, simd<R> rhs) noexcept
...
template <simd_element L, simd_element R>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline auto bwornot(abi_tag, simd<L> lhs, simd<R> rhs) noexcept
...
inline mask<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwor(mask<L> lhs, mask<R> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwand(mask<L> lhs, mask<R> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwxor(mask<L> lhs, mask<R> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwandnot(mask<L> lhs, mask<R> rhs) noexcept {
    return +xmm::bwandnot(simd<L>(+lhs), simd<R>(+rhs));
}

template <simd_element E>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<E> DPL_VECTORCALL bwnot(mask<E> val) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<common_bits_type_t<L, R>> DPL_VECTORCALL
    bwornot(mask<L> lhs, mask<R> rhs) noexcept {
...
inline mask<E> DPL_VECTORCALL
    bwshift_left(mask<E> val, immediate<V> imm = dx::imm<V>) noexcept {
    if constexpr (floating_point<E>) {
        using bit = unsigned_representation_t<E>;
        return xmm::reinterpret<E>(
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline mask<E> DPL_VECTORCALL
    bwshift_right(mask<E> val, immediate<V> imm = dx::imm<V>) noexcept {
    if constexpr (floating_point<E>) {
        using bit = unsigned_representation_t<E>;
        return xmm::reinterpret<E>(
...
template <integral auto V, simd_element E>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline mask<E> bwshift_left(
    abi_tag, mask<E> val, immediate<V> imm = dx::imm<V>) noexcept
requires requires { xmm::bwshift_left<V>(val); }
{
    return xmm::bwshift_left<V>(val);
}
template <integral auto V, simd_element E>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline mask<E> bwshift_right(
    abi_tag, mask<E> val, immediate<V> imm = dx::imm<V>) noexcept
requires requires { xmm::bwshift_right<V>(val); }
{
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<E> DPL_VECTORCALL
    bwshift_left(simd<E> val, immediate<V> imm = dx::imm<V>) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline simd<E> DPL_VECTORCALL
    bwshift_right(simd<E> val, immediate<V> imm = dx::imm<V>) noexcept {
    static_assert(V >= 0 && V < sizeof(E) * char_bit_v);
    if constexpr (floating_point<E>) {
        using bit = unsigned_representation_t<E>;
        return xmm::reinterpret<E>(
...
template <integral auto V, simd_element E>
DPL_ATTRIBUTES(_HIDE_FROM_ABI, ALWAYS_INLINE, NODISCARD)
inline simd<E> bwshift_left(
    abi_tag, simd<E> val, immediate<V> imm = dx::imm<V>) noexcept
requires requires { xmm::bwshift_left<V>(val); }
{
    return xmm::bwshift_left<V>(val);
}
...
#  endif
        ...
        xmm2 = +xmm::bwshift_left(simd<i16>(xmm2), simd<i16>(xmm3));

        xmm1 = _mm_cvtepi8_epi16(_mm_srli_si128(xmm1, 8));
        xmm0 = _mm_cvtepi8_epi16(_mm_srli_si128(xmm0, 8));
        xmm0 = +xmm::bwshift_left(simd<i16>(xmm0), simd<i16>(xmm1));
...
#  endif
        ...
        if constexpr (unsigned_integral<L>) {
            ...
            xmm2 = +xmm::bwshift_right(simd<i16>(xmm2), simd<i16>(xmm3));
            xmm1 = _mm_srli_si128(xmm1, 8);
            xmm0 = _mm_srli_si128(xmm0, 8);
            xmm1 = _mm_cvtepu8_epi16(xmm1);
            xmm0 = _mm_cvtepu8_epi16(xmm0);
            xmm0 = +xmm::bwshift_right(simd<i16>(xmm0), simd<i16>(xmm1));
            xmm1 = _mm_srli_epi16(_mm_cmpeq_epi32(xmm1, xmm1), 8);
            xmm2 = _mm_and_si128(xmm2, xmm1);
            xmm1 = _mm_and_si128(xmm0, xmm1);
            return _mm_packus_epi16(xmm2, xmm1);
...
inline simd<L> DPL_VECTORCALL bwshift_left(simd<L> lhs, simd<R> rhs) noexcept {
    if constexpr (floating_point<L>) {
        ...
        xmm2 = +xmm::bwshift_left(simd<i32>(xmm2), simd<i32>(xmm3));

        xmm1 = _mm_cvtepi16_epi32(_mm_srli_si128(xmm1, 8));
        xmm0 = _mm_cvtepi16_epi32(_mm_srli_si128(xmm0, 8));
        xmm0 = +xmm::bwshift_left(simd<i32>(xmm0), simd<i32>(xmm1));
        ...
        auto xmm3 = _mm_cvtepi8_epi16(xmm1);
        auto xmm2 = _mm_cvtepi8_epi16(xmm0);
        xmm2 = +bwshift_left(simd<i16>(xmm2), simd<i16>(xmm3));

        xmm1 = _mm_cvtepi8_epi16(_mm_srli_si128(xmm1, 8));
        xmm0 = _mm_cvtepi8_epi16(_mm_srli_si128(xmm0, 8));
        xmm0 = +bwshift_left(simd<i16>(xmm0), simd<i16>(xmm1));
