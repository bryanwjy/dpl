...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::float16> DPL_VECTORCALL fnmsub(vector<ext::float16> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::bfloat16> DPL_VECTORCALL fnmsub(vector<ext::bfloat16> lhs,
    ...
    auto const lo = xmm::fnmsub(xmm::element_cast<float>(lhs),
        xmm::element_cast<float>(mid), xmm::element_cast<float>(rhs));
    auto const hi = xmm::fnmsub(xmm::element_cast<float>(hlhs),
...
constexpr vector<E> fnmsub(
    abi_tag, vector<E> lhs, vector<E> mid, vector<E> rhs) noexcept
requires requires { xmm::fnmsub(lhs, mid, rhs); }
{
    return xmm::fnmsub(lhs, mid, rhs);
}
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<float>
    DPL_VECTORCALL fnmsub(vector<float> lhs, cmask_t<float, M> mask,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<float>
    DPL_VECTORCALL fnmsub(dx::zero_t, cmask_t<float, M> mask, vector<float> lhs,
        vector<float> mid, vector<float> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<float>
    DPL_VECTORCALL fnmsub(vector<float> lhs, vector<float> mid,
...
inline vector<ext::bfloat16>
    DPL_VECTORCALL fnmsub(vector<ext::bfloat16> lhs,
    ...
    auto const lo = xmm::fnmsub(xmm::element_cast<float>(lhs), lmask,
        xmm::element_cast<float>(mid), xmm::element_cast<float>(rhs));
    auto const hi = xmm::fnmsub(xmm::element_cast<float>(hlhs), hmask,
        xmm::element_cast<float>(hmid), xmm::element_cast<float>(hrhs));
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::bfloat16>
    DPL_VECTORCALL fnmsub(dx::zero_t zero, cmask_t<ext::bfloat16, M> mask,
    ...
    constexpr cmask_t<float, (M & 0xf)> lmask;
    constexpr cmask_t<float, (M >> 4)> hmask;
    auto const lo = xmm::fnmsub(zero, lmask, xmm::element_cast<float>(lhs),
        xmm::element_cast<float>(mid), xmm::element_cast<float>(rhs));
    auto const hi = xmm::fnmsub(zero, hmask, xmm::element_cast<float>(hlhs),
        xmm::element_cast<float>(hmid), xmm::element_cast<float>(hrhs));
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::bfloat16>
    DPL_VECTORCALL fnmsub(vector<ext::bfloat16> lhs, vector<ext::bfloat16> mid,
...
inline vector<double>
    DPL_VECTORCALL fnmsub(vector<double> lhs, cmask_t<double, M> mask,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<double>
    DPL_VECTORCALL fnmsub(dx::zero_t, cmask_t<double, M> mask,
        vector<double> lhs, vector<double> mid, vector<double> rhs) noexcept {
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<double>
    DPL_VECTORCALL fnmsub(vector<double> lhs, vector<double> mid,
...
inline vector<ext::float16>
    DPL_VECTORCALL fnmsub(vector<ext::float16> lhs,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::float16>
    DPL_VECTORCALL fnmsub(dx::zero_t, cmask_t<ext::float16, M> mask,
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::float16>
    DPL_VECTORCALL fnmsub(vector<ext::float16> lhs, vector<ext::float16> mid,
