...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::bfloat16> DPL_VECTORCALL fnmadd(vector<ext::bfloat16> lhs,
    ...
    auto const lo = xmm::fnmadd(xmm::element_cast<float>(lhs),
        xmm::element_cast<float>(mid), xmm::element_cast<float>(rhs));
    auto const hi = xmm::fnmadd(xmm::element_cast<float>(hlhs),
...
constexpr vector<E> fnmadd(
    abi_tag, vector<E> lhs, vector<E> mid, vector<E> rhs) noexcept
requires requires { xmm::fnmadd(lhs, mid, rhs); }
{
    return xmm::fnmadd(lhs, mid, rhs);
}
...
inline vector<ext::bfloat16>
    DPL_VECTORCALL fnmadd(vector<ext::bfloat16> lhs,
    ...
    auto const lo = xmm::fnmadd(xmm::element_cast<float>(lhs), lmask,
        xmm::element_cast<float>(mid), xmm::element_cast<float>(rhs));
    auto const hi = xmm::fnmadd(xmm::element_cast<float>(hlhs), hmask,
        xmm::element_cast<float>(hmid), xmm::element_cast<float>(hrhs));
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::bfloat16>
    DPL_VECTORCALL fnmadd(dx::zero_t zero, cmask_t<ext::bfloat16, M> mask,
    ...
    constexpr cmask_t<float, (M & 0xf)> lmask;
    constexpr cmask_t<float, (M >> 4)> hmask;
    auto const lo = xmm::fnmadd(zero, lmask, xmm::element_cast<float>(lhs),
        xmm::element_cast<float>(mid), xmm::element_cast<float>(rhs));
    auto const hi = xmm::fnmadd(zero, hmask, xmm::element_cast<float>(hlhs),
        xmm::element_cast<float>(hmid), xmm::element_cast<float>(hrhs));
...
DPL_ATTRIBUTES(_HIDE_FROM_ABI, CONST, NODISCARD)
inline vector<ext::bfloat16>
    DPL_VECTORCALL fnmadd(vector<ext::bfloat16> lhs, vector<ext::bfloat16> mid,
