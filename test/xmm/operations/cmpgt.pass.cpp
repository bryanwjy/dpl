...
// Tests for dpp::cmpgt on xmm ABI. Requires SSE4.2 (implied by dpl.xmm).
//
// Forms tested:
//   (1) dpp::cmpgt(lhs, rhs)        -- unmasked, always available
//   (2) dpp::cmpgt(mask, lhs, rhs)  -- merge-masked
...
int main() {
    ...
    constexpr auto run = []() {
        ...
        return dpl::test::gt_comparison<abi_t>::run_all(types{}, engine);
    };
