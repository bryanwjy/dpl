...
// Tests for dpp::fnmsub on xmm ABI. Requires SSE4.2 (implied by dpl.xmm).
//
// Forms tested:
//   (1) dpp::fnmsub(a, b, c)                  -- unmasked, always available
//   (2) dpp::fnmsub(src, mask, a, b, c)       -- merge-masked
//   (3) dpp::fnmsub(dpp::zero, mask, a, b, c) -- zero-masked explicit
//   (4) dpp::fnmsub(mask, a, b, c)            -- zero-masked alias (== form 3)
