...
// Tests for dpp::cmpeq on xmm ABI. Requires SSE4.2 (implied by dpl.xmm).
//
// Forms tested:
//   (1) dpp::cmpeq(lhs, rhs)        -- unmasked, always available
//   (2) dpp::cmpeq(mask, lhs, rhs)  -- merge-masked
...
int main() {
    ...
    constexpr auto run = []() {
        ...
        return dpl::test::eq_comparison<abi_t>::run_all(types{}, engine);
    };
