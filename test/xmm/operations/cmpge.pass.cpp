...
// Tests for dpp::cmpge on xmm ABI. Requires SSE4.2 (implied by dpl.xmm).
//
// Forms tested:
//   (1) dpp::cmpge(lhs, rhs)        -- unmasked, always available
//   (2) dpp::cmpge(mask, lhs, rhs)  -- merge-masked
...
int main() {
    ...
    constexpr auto run = []() {
        ...
        return dpl::test::ge_comparison<abi_t>::run_all(types{}, engine);
    };
