...
//   (2) dpp::reinterpret<E>(src, mask, val)       -- merge-masked
//   (3) dpp::reinterpret<E>(dpp::zero, mask, val) -- zero-masked explicit
//   (4) dpp::reinterpret<E>(mask, val)            -- zero-masked alias (== form
//   3)
