...
// Tests for dpp::cmple on xmm ABI. Requires SSE4.2 (implied by dpl.xmm).
//
// Forms tested:
//   (1) dpp::cmple(lhs, rhs)        -- unmasked, always available
//   (2) dpp::cmple(mask, lhs, rhs)  -- merge-masked
...
int main() {
    ...
    constexpr auto run = []() {
        ...
        return dpl::test::le_comparison<abi_t>::run_all(types{}, engine);
    };
