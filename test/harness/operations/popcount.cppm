    ...
    static constexpr bool run(Rng& engine) {
        ...
        if constexpr (dpp::fixed_width_abi<A>) {
            ...
            for (auto i = 0zu; i < 4; ++i) {
                ...
                auto const expected = dpl::to_unsigned(dpl::popcount(data));
                assert(dpp::popcount(dpp::from_bitset<A, E>(data)) == expected);
            }
        }
